...
public class GameController {
    ...
    //region Dev0
    @FXML
    public Label dev_0_name;
    @FXML
    public Label dev_0_level;
    @FXML
    public Label dev_0_salary;
    @FXML
    public Button dev_0_upgrade_quality;
    @FXML
    public Button dev_0_upgrade_codeSpeed;
    @FXML
    public Label dev_0_cost_codeSpeed;
    @FXML
    public Label dev_0_cost_quality;
    @FXML
    private Label levelCodingSpeed_0;
    @FXML
    private Label levelQualityOfCode_0;
    @FXML
    ...
    //region Dev1
    @FXML
    public Label dev_1_name;
    @FXML
    public Label dev_1_level;
    @FXML
    public Label dev_1_salary;
    @FXML
    public Button dev_1_upgrade_quality;
    @FXML
    public Button dev_1_upgrade_codeSpeed;
    @FXML
    public Label dev_1_cost_codeSpeed;
    @FXML
    public Label dev_1_cost_quality;
    @FXML
    private Label levelCodingSpeed_1;
    @FXML
    private Label levelQualityOfCode_1;
    @FXML
    public ProgressBar dev_1_progress;
    @FXML
    public Label dev_1_lastWork;
    @FXML
    private Tooltip dev_1_upgradeCodingSpeedTooltip = new Tooltip();
    @FXML
    private Tooltip dev_1_upgradeQualityOfCodeTooltip = new Tooltip();
    //endregion
    //region Dev2
    @FXML
    public Label dev_2_name;
    @FXML
    public Label dev_2_level;
    @FXML
    public Label dev_2_salary;
    @FXML
    public Button dev_2_upgrade_quality;
    @FXML
    public Button dev_2_upgrade_codeSpeed;
    @FXML
    public Label dev_2_cost_codeSpeed;
    @FXML
    public Label dev_2_cost_quality;
    @FXML
    private Label levelCodingSpeed_2;
    @FXML
    private Label levelQualityOfCode_2;
    @FXML
    public ProgressBar dev_2_progress;
    @FXML
    public Label dev_2_lastWork;
    @FXML
    private Tooltip dev_2_upgradeCodingSpeedTooltip = new Tooltip();
    @FXML
    private Tooltip dev_2_upgradeQualityOfCodeTooltip = new Tooltip();
    //endregion
    //region Dev3
    @FXML
    public Label dev_3_name;
    @FXML
    public Label dev_3_level;
    @FXML
    public Label dev_3_salary;
    @FXML
    public Button dev_3_upgrade_quality;
    @FXML
    public Button dev_3_upgrade_codeSpeed;
    @FXML
    public Label dev_3_cost_codeSpeed;
    @FXML
    public Label dev_3_cost_quality;
    @FXML
    private Label levelCodingSpeed_3;
    @FXML
    private Label levelQualityOfCode_3;
    @FXML
    public ProgressBar dev_3_progress;
    @FXML
    public Label dev_3_lastWork;
    @FXML
    private Tooltip dev_3_upgradeCodingSpeedTooltip = new Tooltip();
    @FXML
    private Tooltip dev_3_upgradeQualityOfCodeTooltip = new Tooltip();
    //endregion
    ...
    protected void hireNewDev() throws IOException {
        ...
        if (game.developers.size() == 4) {
            //Room is full
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Office Space required");
            alert.setHeaderText("Fire a developer to make room for new talent.");
            alert.setContentText("A Startup can't be picky");
            alert.showAndWait();
            resumeGame();
            return;
        }
    ...
    private Alert fireDevPopup() {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
        alert.setTitle("Confirmation");
        alert.setHeaderText("Fire Developer");
        alert.setContentText("Do you really want to fire this developer?");
    ...
    private void rebindDevelopers(int devToBeFired) {
        List<Developer> rDevs = new ArrayList<>(game.developers.get()); //now mutable deep copy
        rDevs.remove((int) devToBeFired);

        int devPosition = 0;
        game.developers.remove(devToBeFired);
        for (Developer dev : rDevs) {
            bindNewDeveloper(devPosition);
            devPosition++;
        }
        developerGrids.get(rDevs.size()).setVisible(false); //Hide last spot
    }

    @FXML
    protected void fireDev1() {
        Optional<ButtonType> result = fireDevPopup().showAndWait();
    ...
    public void completeContract(ActionEvent actionEvent) {
        ...
        //update ui
        game.totalContractsCompleted.set(game.totalContractsCompleted.get() + 1);
        //winning
        if (game.totalContractsCompleted.get() >= 10) {
            pauseGame();
            showWinPopup();
            resumeGame();
        }
    ...
    private void showWinPopup() {
        ...
        winLabel.setStyle("-fx-font-size: 36px;-fx-font-weight: bold;-fx-text-fill: gold;");

        Button ok = new Button("Yeah!");
        ok.setOnAction(e -> popup.close());

        VBox root = new VBox(20, winLabel, ok);
        root.setAlignment(Pos.CENTER);
        root.setPadding(new Insets(30));
        root.setStyle("-fx-background-color: rgba(0,0,0,0.85);-fx-background-radius: 20;");
