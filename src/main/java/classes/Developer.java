...
public class Developer {
    ...
    public int getCodingSpeed() {
        return codingSpeed.getRank().get();
    }

    public float getSuccessRate() {
        return (float) successRate.getRank().get();
    }
    ...
    public Attribute getcodingSpeed() {
        return codingSpeed;
    }

    public Attribute getsuccessRate() {
        return successRate;
    }
    ...
    public IntegerProperty getCodingSpeedProperty() {
        return this.codingSpeed.getRank();
    }

    public IntegerProperty getSuccessRateProperty() {
        return this.successRate.getRank();
    }
    ...
    public StringProperty getDeveloperNameProperty() {
        return this.name;
    }

    public StringProperty getDeveloperTitle() {
        return this.title;
    }

    public IntegerProperty getWrittenLinesInLastWorkstepProperty() {
        return this.writtenLinesInLastWorkstep;
    }
