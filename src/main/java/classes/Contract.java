...
public class Contract {
    ...
    //Observable properties
    public StringProperty getContractNameProperty() {
        return this.contractName;
    }

    public StringProperty getContractDescriptionProperty() {
    ...
    public void setContractLinesProperty() {
        this.contractLinesProperty.set(numberOfLinesWritten + " / " + numberOfLinesNeeded);
    }
    ...
    public void setNumberOfLinesWritten(int numberOfLinesWritten) {
    ...
    public void setContractDescription(String contractDescription) {
        this.contractDescription.set(contractDescription);
    }
