...
public class Game {
    ...
    public void paySalaries() {
        ...
        for (Developer dev : this.developers) {
            totalSalaries += dev.getSalary();
        }

        this.currentCapital.set(this.currentCapital.get() - totalSalaries);
    }
    ...
    public int getStartingCapital() {
        return this.startingCapital.get();
    }

    public void setStartingCapital(int startingCapital) {
        this.startingCapital.set(startingCapital);
    }

    public Department getFirstOffice() {
        return firstOffice;
    }

    public void setFirstOffice(Department firstOffice) {
    ...
    public void setCurrentContract(Contract currentContract) {
        this.currentContract.set(currentContract);
    }

    public int getCurrentCapital() {
        return this.currentCapital.get();
    }

    public void setCurrentCapital(int currentCapital) {
        this.currentCapital.set(currentCapital);
    }

    public int getCurrentDay() {
        return this.currentDay.get();
    }
